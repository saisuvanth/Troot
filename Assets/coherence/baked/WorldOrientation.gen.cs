...
namespace Coherence.Generated
{
	...
	public struct WorldOrientation : ICoherenceComponentData
	{
		...
		public static (WorldOrientation, uint, uint?) DeserializeArchetypeCube_78fdd04f22ed43f40bf52f012fa8bf3b_WorldOrientation_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new WorldOrientation();
			if (bitStream.ReadMask())

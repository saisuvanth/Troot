...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncGameManager : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncGameManager>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncGameManager] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
